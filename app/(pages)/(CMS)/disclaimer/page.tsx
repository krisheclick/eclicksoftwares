...
export async function generateMetadata(): Promise<Metadata> {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/page/disclaimer/seo`, {
...
const content = {
    bannerTitle: 'Disclaimer Technology Partner',
...
const Page = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/page/disclaimer`);
