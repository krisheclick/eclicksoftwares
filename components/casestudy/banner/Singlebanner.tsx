                ...
                <Row>
                        ...
                        <div className={Styles.leftContent}>
                            ...
                            <div className={Styles.anotherPart}>
                                <div className={Styles.projectName}>
                                    <span>Client</span>
                                    {data?.client?.client_name || 'JKC Toymaster'}
                                </div>
                                <div className={Styles.projectName}>
                                    <span>Industry</span>
                                    {data?.client?.industry?.industry_title || `Gift, greeting cards & general kids items`}
                                </div>
                            </div>
                        </div>
                    </Col>
                    ...
                    <Col lg={3}>
                        ...
                        <div className={Styles.campaignList}>
                            <span>SEO</span>,  <span>GOOGLE ADS</span>, <span>META ADS</span>
                        </div>
                    </Col>
                </Row>
            </Container>
